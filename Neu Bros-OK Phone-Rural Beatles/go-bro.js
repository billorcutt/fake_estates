...
__().sine({id:"s1"}).gain({id:"g1"}).panner(1).overdrive().dac(0);
__().sine({id:"s2"}).gain({id:"g2"}).panner(-1).overdrive().dac(0);
...
var tempo_max = tempo;
var tempo_min = tempo;
var tempo_min_array = [90,95,100,105,110,115,120];
...
__.loop(tempo,function(f) {
    ...
    if(env_test_func()) {
        ...
        __("#d3").ramp(__.ms2sec(env_delay_array[env_delay]),__.ms2sec(0),"delay");
    ...
    if(env_test_func2()) {
        ...
        __("#d4").ramp(__.ms2sec(env_delay_array[env_delay2]),__.ms2sec(0),"delay");
...
function dispatch_control(item) {
    switch(item.y) {
        case 7:
            ...
            break;
        default:
            tempo_min = tempo_min_array[item.y] || tempo;
            break;
    }
}
...
function dispatch_preset(item) {
    switch(item.y) {
        ...
        case 6:
          ...
          __("#g1,#g2").ramp(0.5/4,__.ms2sec(10),"gain");
          //__("#g3,#g4").volume(1/2-1/8-1/32);
          break;
        case 7:
          //__("#g1,#g2").volume(1/4);
          __("#g1,#g2").ramp(0.7/4,__.ms2sec(10),"gain");
          //__("#g3,#g4").volume(1/2-1/8-1/32);
          break;
        default:
            break;
